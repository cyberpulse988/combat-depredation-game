...
fightext_character.basicSet(img`
    ...
    fightext_character.setAbility(player2, fightext_character.abilityKind.damageB, 56)
...
fightext_skill.skillSet("Skelly", function (player2) {
    fightext_skill.setSkill(player2, fightext_skill.SkillKind.A1, 0, function (tempVar, undefined) {
